...
class FeatureDashBoard extends StatefulWidget {
  ...
  FeatureDashBoard({super.key, required this.ProjectId});

  @override
  State<FeatureDashBoard> createState() => _FeatureDashBoardState();
}

class _FeatureDashBoardState extends State<FeatureDashBoard> {
  @override
  void initState() {
        ...
        child: Column(
          ...
          children: [
            ...
            DashBoardAddSection(
              ...
              onTap: () async {
           await     GoRouter.of(context).pushNamed(Names.AddNewFeaturePage,extra: {
                  'completeKey': completeKey,
                  'textControllers': textEditingController,
                  'text1': 'Add Feature Name',
                  'text2': 'Add Feature Description',
                  'text3': 'Add Feature Languge',
                  'iConData1': Icons.wallet_travel,
                  'iConData2': Icons.text_format,
                  'iConData3': Icons.language,
                  'title': 'Create Feature','projectId':widget.ProjectId});
           BlocProvider.of<ProjectBloc>(context).add(getAllFeaturesForProject(widget.ProjectId));
              },
            ),
            SizedBox(
                    ...
                    child: ListView.separated(
                        itemBuilder: (context, index) {
                          return InkWell(onTap: () {
                            GoRouter.of(context).pushNamed(Names.PageDashBoard ,extra: state.showAllProjectModel.data![index].id);
                          },
                            child: Container(
                              //  height: 100,
